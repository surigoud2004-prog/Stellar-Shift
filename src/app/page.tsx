...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-[#0a0512]">
      ...
      {/* STRICT HUD (Heads-Up Display) */}
      <header className="fixed top-0 inset-x-0 p-6 z-[999] pointer-events-none">
        <div className="flex justify-between items-start w-full max-w-7xl mx-auto">
          
          {/* Top-Left Anchor: Abort Control */}
          <div className="flex flex-col gap-4 pointer-events-auto">
            {gameStarted && (
              <button 
                onClick={() => setAbortDialogOpen(true)}
                className="w-[50px] h-[50px] rounded-full glass-panel border-destructive/50 bg-black/40 flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(239,68,68,0.3)] z-[100]"
            ...
            <button 
              ...
              className="w-10 h-10 rounded-full glass-panel border-white/10 hover:border-primary/50 transition-all flex items-center justify-center group active:scale-90"
          ...
          <div className={cn(
            ...
            {gameStarted && (
              <div className="mt-12 flex flex-col items-center animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <div className="flex flex-col items-end gap-4 pointer-events-auto">
            <div className="flex items-center gap-4">
              ...
              <button 
                ...
                className={cn(
                  "w-12 h-12 rounded-full glass-panel flex items-center justify-center border-primary/30 hover:border-primary transition-all shadow-lg active:scale-90",
                  !uiVisible && "opacity-0 pointer-events-none"
                )}
              >
